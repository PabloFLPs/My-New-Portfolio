      ...
      <div className="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
        <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="max-w-lg mx-auto">
            <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">Get in <span className="text-clear-brown">Touch</span></h2>
            ...
            <dl className="mt-8 text-base text-gray-500">
              <div className="mt-6">
                ...
                <dd className="flex">
                  <RiPhoneFill className="flex-shrink-0 h-6 w-6 text-clear-brown" aria-hidden="true" />
              ...
              <div className="mt-3">
                ...
                <dd className="flex">
                  <RiMailFill className="flex-shrink-0 h-6 w-6 text-clear-brown" aria-hidden="true" />
