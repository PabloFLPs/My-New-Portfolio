...
export default function AboutMe() {
    return (
        <>
            <section id="About" className="py-6 pt-20 bg-dark text-white overflow-hidden md:py-12 lg:pt-24">
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="relative">
                    <h2 className="text-center text-3xl font-bold">
                        Web <span className="text-light-brown">Developer</span>
                    </h2>
            ...
            <div className="bg-dark pt-16 lg:py-24">
                ...
                <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
                        ...
                        <div>
                            <svg
                            className="h-12 w-12 text-light-brown"
                            fill="currentColor"
                            viewBox="0 0 32 32"
                            aria-hidden="true"
                            >
                        ...
                        <footer className="mt-6">
                            <p className="text-base font-medium text-light-brown">Judith Black</p>
